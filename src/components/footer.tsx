        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div id="contact" className="animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ...
            <ul className="space-y-3 text-sm text-accent-foreground/80">
              ...
              <li>
                <a href="https://www.instagram.com/ds_creacakes/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-all duration-300 hover:text-primary group">
                  ...
                  <span className="underline-animation">@ds_creacakes</span>
                </a>
              </li>
              <li>
